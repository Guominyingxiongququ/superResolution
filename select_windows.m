...
function [window_list,score_list] = select_windows(conf,ranking)
    for j = 3
        ...
        [window_list,score_list] = select_part_patch(window_truth,window_test,select_num,ranking);
    end
end

function [patch_list,score_list] = select_part_patch(patches_truth,patches_test,select_num,ranking) 
    ...
    for i = 1:select_num
        ...
        score_list(i) = sortedValue_score(i+select_num*(ranking-1));
    end
end